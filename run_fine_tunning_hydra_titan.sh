#!/bin/bash
#SBATCH --job-name=whysper_filtering_distrib_hydra_large
...
torchrun --nnodes=1 --nproc_per_node=1 --rdzv_backend=static --rdzv_endpoint=localhost:29501 main_titan.py
