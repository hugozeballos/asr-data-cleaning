...
def inference_and_compute_cer(model, dataset, processor, batch_size=2):
    """
...
#    hf_dataset_repo,         # Ejemplo: "HugoZeballos/original-audio-dataset-with-inferencesofwhysper-and-metrics"
    ...
    output_dataset_repo="HugoZeballos/Dataset_filtrado_iterativo_distribuido_final",
    test_mode=False         # <-- Nuevo parámetro para modo test
):
    """
...
#    login("REDACTED_HF_TOKEN")
    ...
    iterative_filter_whisper(
        ...
        first_filter_percent=1.5,
        subsequent_filter_percent=2.0,
        train_kwargs={"num_train_epochs": 20, "per_device_train_batch_size": 1},  # Ajusta según config y recursos.
